...
const NAV = [
  {
    href: '/armas',
    label: 'Armas',
    icon: <path strokeLinecap="round" strokeLinejoin="round" d="M15.362 5.214A8.252 8.252 0 0112 21 8.25 8.25 0 016.038 7.048 8.287 8.287 0 009 9.608a8.983 8.983 0 013.361-6.867 8.21 8.21 0 003 2.473z" />,
  },
  {
    href: '/items',
    label: 'Items',
...
export default function NavSidebarLinks() {
      ...
      {NAV.map((item) => {
        ...
        return (
          <Link
            key={item.href}
            href={item.href}
            className={`relative flex h-10 w-full items-center gap-3 overflow-hidden rounded-xl px-2.5 transition-colors ${
              active
          ...
          >
            {/* Active indicator */}
            {active && (
              <span className="absolute left-0 top-1/2 h-4 w-0.5 -translate-y-1/2 rounded-full bg-[var(--app-accent)]" />
            )}
            ...
            {/* Label — expands on sidebar hover */}
